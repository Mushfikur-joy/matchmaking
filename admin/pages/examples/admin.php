...
$query = "SELECT `user_id`,`username`,`user_role`,`user_password` FROM `login`";
...
$query1 = "SELECT `username`,`img_1` FROM `login` WHERE `user_id`=".$user_id;
            ...
            <div class="box-body">
              <table class="table table-bordered">
                ...
                <tr>
                  ...
                  <td>
                      <a href="edit.php?user_id=<?=$db_user_id?>"><i class="fa fa-pencil" style="font-size:20px;color:#f39c12;"></i>&nbsp;&nbsp;(Edit)</a>
                      &nbsp;&nbsp;&nbsp;&nbsp;
                      <a href="delete.php?user_id=<?=$db_user_id?>"><i class="fa fa-trash" style="font-size:20px;color:#e74c3c;"></i>&nbsp;&nbsp;(Delete)</a>
                  </td>
                </tr>
                <?php
                }
              ...
              <br>
              <a href="add_user.php" class="btn btn-info btn-lg">Add New User</a>
            </div>
