...
$user_name = $_GET["search_user"];

$query = "SELECT `user_id`,`username`,`img_1`,`img_2`,`img_3`,`img_4`,`img_5` FROM `login` WHERE `username` LIKE '%".$user_name."%'";
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <!--    <a href="chat/chat.php?user_id=<?=$_GET["user_id"]?>" class="btn btn-primary btn-block"><b>Chat</b></a>    -->
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
